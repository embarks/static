...
const VARIANT_MAP = {
  ...
  info: [THEME_COLORS.text, THEME_COLORS.brightGreen, THEME_COLORS.text],
  ...
  link: [THEME_COLORS.black, THEME_COLORS.brightBlue, THEME_COLORS.black],
  ...
  bold: [THEME_COLORS.text, THEME_COLORS.bold, THEME_COLORS.text],
  black: [THEME_COLORS.light, THEME_COLORS.brightBlack, THEME_COLORS.black],
  subtle: [THEME_COLORS.light, THEME_COLORS.text, THEME_COLORS.text],
